...
inline String RadarCompactLine = "📐 Ср: --.-- м | 📏 LD2420: --.-- м | 📏 HLK: --.-- м"; // Компактная строка расстояний без наложения поверх элементов.
inline float RadarAverageDistanceM = 0.0f; // Средняя дистанция по двум радарным датчикам в метрах.
inline int RadarAverageValidSensors = 0; // Сколько датчиков участвовало в расчете среднего (0..2).
inline int RadarAverageAgeMs = 0; // Возраст усредненного значения, чтобы видеть свежесть данных.
