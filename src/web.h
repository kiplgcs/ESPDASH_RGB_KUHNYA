...
inline String RadarCompactLine = "📏 LD2420: --.-- м | 🎯 Цель: -- | ⌛ Age: -- ms"; // Компактная строка состояния единственного радара LD2420.
inline float RadarAverageDistanceM = 0.0f; // Текущая дистанция LD2420 в метрах (поле сохранено для совместимости UI).
inline int RadarAverageValidSensors = 0; // Флаг валидности LD2420 (0/1).
inline int RadarAverageAgeMs = 0; // Возраст текущего значения LD2420 (мс).
